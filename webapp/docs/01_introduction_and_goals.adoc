...
| Clientes | Han planteado las guías para la realización del proyecto. Son los encargados de la evaluación del mismo. | Conseguir que los alumnos tengan en cuenta la arquitectura del software a la hora de desarrollar proyectos.
